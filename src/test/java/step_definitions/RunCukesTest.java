...
@CucumberOptions(features = "src/test/resources/features",glue= { "step_definitions" }, plugin = { "pretty", "html:target/cucumber-html-report",
...
public class RunCukesTest extends AbstractTestNGCucumberTests {
	...
	public void onStart() {
		try {
			...
			//htmlReporter = new ExtentHtmlReporter(System.getProperty("user.dir") + ConfigReader.getValue("extentReportPath"));
