...
public class MobileKeywords2 {
	...
	public static void AmazonscrollAndClick(String visibleText) throws InterruptedException {
	
	    GlobalUtil.mdriver.findElementByAndroidUIAutomator("new UiScrollable(new UiSelector().scrollable(true).instance(0)).scrollIntoView(new UiSelector().textContains('Add to Cart').instance(0))").click();
		//GlobalUtil.mdriver.findElementByAndroidUIAutomator("new UiScrollable(new UiSelector().scrollable(true).instance(0)).scrollIntoView(new UiSelector().textContains(\""+visibleText+"\").instance(0))").click();
		KeywordUtil.delay(700);
