...
public class AndriodConstants {
	...
	public static class Amazon {
		...
		public static final String MainMenu = "//*[@resource-id='in.amazon.mShop.android.shopping:id/action_bar_burger_icon']";
		public static final String Home = "//*[@resource-id='in.amazon.mShop.android.shopping:id/drawer_item_title']";
		
		public static final String SearchBox = "in.amazon.mShop.android.shopping:id/rs_search_src_text";
		public static final String penclick = "//*[@index='0']";
		
		public static final String PinCodeClick = "in.amazon.mShop.android.shopping:id/loc_ux_gps_enter_pincode";
		public static final String PinCodeapply ="in.amazon.mShop.android.shopping:id/loc_ux_update_pin_code";
		
		public static final String firstButtonClick = "//*[@index='0']";
		public static final String shop_by_category_btn = "web_home_shop_by_department_label";
		
		//public static final String shop_by_category_btn = "//*[@resource-id='in.amazon.mShop.android.shopping:id/drawer_item_title']";
